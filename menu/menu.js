let menu =JSON.parse(localStorage.getItem ("menu")) || [];
 ...
 let  displayData =(data) =>{
    ...
    data.forEach((element)=> {
        ...
        let {pic:{url1},brand,inside: {calories},diet:{gluten}} = element;
        ...
        if (h2.innerHTML == "Coq Au Vin"){
            img.src = "https://assets-global.website-files.com/5d03b4e13011831ae4624b37/638304ad18cd936ea9f3ae36_production-meal-image-26eb81cd-a53a-47ed-a7da-56cc1b7272ef-p-500.jpeg";
        }
 ...
 function displayModel(id){
    let div = document.getElementById("inner-container");
          ...
          item.forEach((element) => {
            let {pic:{url1},pic:{url2},brand,diet:{gluten},inside:{calories,carbs,total_fat,protien}} = element;
